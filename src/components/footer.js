...
const Footer = () => {
  const clickYellowpine = () => {
    typeof window !== "undefined" && window.ym(62048629,'reachGoal','yellowpine')
  };
  const clickContacts = () => {
    typeof window !== "undefined" && window.ym(62048629,'reachGoal','phone_footer')
  };
  return (
      ...
      <footer className="footer">
        <div className="footer_grid">
          <div className="footer_flex_left">
            <div className="footer_flex">
              <div className="footer_address">
                <p className="footer_address_p">Адрес: г. Минск, пр.&nbsp;Победителей&nbsp;129, оф.351</p>
          ...
          <div className="footer_socials">
            <a href="https://www.facebook.com/rhome.by/" rel="nofollow" className="footer_social_fa footer_social_link">
              <div className="footer_socials_fa_img"></div>
            </a>
            <a href="https://www.instagram.com/rhome.by/" rel="nofollow" className="footer_social_in footer_social_link">
        ...
        <div className="footer_copyright">
          ...
          <div className="footer_developer">
            ...
            <a
              href="https://yellowpine.site/"
              className="footer_developer_link"
              onClick={() => {clickYellowpine();}}
            >Yellowpine</a>
          </div>
        </div>
      </footer>
