...
export const ProjectTaskSergey = ({ taskText , wishText }) => {
  ...
  return (
    <div className={styles.project_task + " " + styles.project_task_sergey}>
      <div className={styles.project_task_bcg}>
        <div className={styles.project_task_text + " " + styles.project_task_text_sergey}>
      ...
      <div className={styles.project_task_person}>
        <StaticImage
          src="../../../images/personal/project_task_sergey.jpg"
          alt="Сергей, руководитель студии"
        />
        <p className={styles.project_task_person_status}>Сергей,<br />руководитель студии</p>
      </div>
